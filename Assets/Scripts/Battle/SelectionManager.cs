                    ...
                    foreach (RaycastHit2D hit in hits)
                    {
                        ...
                        if (newTile != null && !newTile.IsImpassable)
                        {
                            if (currentPawn.OnPlayerTeam)
                            {
                                ...
                                else if (currentPawn.CurrentTile.GetTilesInRange(currentPawn, currentPawn.MoveRange).Contains(newTile) && targetPawn == null && Ability.SelectedAbility == null && _selectedTile != null)
                                {
                                    ClearHighlights();
